...
def run_mock_integration_test():
    ...
    # Definiujemy ścieżki (kompatybilne z Windows/Mac/Linux)
    ...
    try:
        ...
        if "STATUS: ZALICZONE" in content:
            # Kolory w terminalu (zielony dla PASS)
            ...
            with open(log_file, 'w', encoding="utf-8") as log:
                ...
                log.write("STATUS: FINAL PASS\n")

            print("\n" + "="*40)
            print(">>> WYNIK KOŃCOWY BLOKU 4: PASS <<<")
            print("="*40)
            print(f"Log został zapisany w: {log_file}")

        else:
            print("\033[91m>>> WYNIK KOŃCOWY BLOKU 4: FAIL <<<\033[0m")
            print("Powód: Twój selektor nie jest unikalny (brak statusu ZALICZONE w pliku).")
